...
export function TemperaturePanel() {
  ...
  return (
    <div className="relative h-full min-h-[330px] overflow-hidden rounded-2xl border border-cyan-300/20 bg-slate-950/70 p-5 shadow-[0_0_70px_rgba(34,211,238,.12)] backdrop-blur-xl">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center text-center">
        ...
        <div className="text-[4.5rem] font-black leading-none tracking-[-0.08em] text-cyan-300 drop-shadow-[0_0_24px_rgba(34,211,238,.55)] md:text-[5.4rem]">
        ...
        <div className="mt-5 max-w-[250px] text-sm font-black leading-6 text-slate-100">
